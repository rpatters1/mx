...
ElisionAttributes::ElisionAttributes()
    : fontFamily(), fontStyle(FontStyle::normal), fontSize(CssFontSize::medium), fontWeight(FontWeight::normal),
      color(), underline(), overline(), lineThrough(), rotation(), letterSpacing(), lang(), dir(), hasFontFamily(false),
      hasFontStyle(false), hasFontSize(false), hasFontWeight(false), hasColor(false), hasUnderline(false),
      hasOverline(false), hasLineThrough(false), hasRotation(false), hasLetterSpacing(false), hasLang(false),
      hasDir(false)
{
}
